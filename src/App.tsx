...
import SpaceStationScene from "./scene/SpaceStationScene";
  ...
  return (
    <div className={cls("h-full w-full", dark ? "bg-black" : "bg-slate-50")}>
      ...
      <div className="absolute inset-0">
        ...
        >
          <color attach="background" args={[dark ? "#03040a" : "#eaf0ff"]} />
          <fog attach="fog" args={[dark ? "#03040a" : "#eaf0ff", 14, 90]} />
          <SpaceStationScene mode={dark ? "dark" : "light"} />
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className={cls("text-xs", dark ? "text-white/60" : "text-slate-600")}>
                  Mission Control V15 — Space Station Interior
                </div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <div className="text-xs text-white/60">
                          ⚠️ Quota faible. Action: Recharger crédits sur platform.openai.com
                        </div>
                      </div>
                    ...
                    <li className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <div className="text-xs text-white/60">
                          ⚠️ Token bientôt expiré. Action: régénérer un PAT et mettre à jour Vercel.
                        </div>
                      </div>
                      <span className="text-xs text-amber-200">Warning</span>
                    </li>
                ...
                <Card title="🚧 Manques">
                  <ul className="space-y-2">
                    <li className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-white/50">Non configuré</span>
                    </li>
                    <li className="flex items-center justify-between">
